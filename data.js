/* ============================================================
   ...
   A NOTE ON ROLES AND VISIBILITY
   Which SCREENS a role can open is a front-end decision (see
   assets/app.js). The API deliberately returns the same data to
   every signed-in user, because a technician standing at a
   machine needs the full equipment register and its history to
   do the job. What the API does enforce is WRITES: delete,
   import and user management are admin-only, and completion
   records can never be rewritten by anyone.
   ============================================================ */
